...
<%
   ...
   //[ MemberVO, MemberVO, MemberVO, .........] <- 반환 받은 ArrayList배열 
   ...
   request.setAttribute("list", membersList);
    ...
    //순서7. 디스패처 방식으로 membersList_java.jsp를 재요청(포워딩)해서 request와 reponse내장객체 메모리 공유!
    RequestDispatcher  dispatcher = request.getRequestDispatcher("membersList_java.jsp");
