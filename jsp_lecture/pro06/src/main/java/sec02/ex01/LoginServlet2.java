...
순서1. 클라이언트가 웹브라우저 주소창에 
      http://localhost:8181/pro06/login2.html을 입력하여 
           정적인 페이지인 login2.html 디자인 화면을 요청합니다.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		/* 
			...
			설정할 MIME-TYPE => 응답할 데이터는 text 기반의 HTML 데이터로 설정,
								모든 응답 문자들의 깨짐을 방지 하기 위해 UTF-8 방식으로 처리해서 응답하겠다고 설정
		*/
		...
		*/
		...
		/*
			...
			응답 방법: 브라우저와 연결된 출력스트림 (PrintWriter 객체)을 통해 응답
		*/
		out.print(data);
	}
